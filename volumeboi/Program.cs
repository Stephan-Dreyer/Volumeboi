...
namespace AudioController
{
    ...
    public interface IAudioEndpointVolume
    {
        ...
        static SerialPort find_arduino() { 
        ...
        List<SerialPort> Portslist = new List<SerialPort>();
...

            {
                ...
                Portslist[i].PortName = ports[i];//Set your board COM
                Portslist[i].BaudRate = 112500;
                Portslist[i].ReadTimeout = 500;
                try { Portslist[i].Open();
    }
                catch
                {
...
return _serialPort;
        ...
        {
            SerialPort _serialPort = find_arduino();
                ...
                while (true)
            {
                try
                {
                    ...
                    Console.WriteLine(a);
                    List<int> volumes = new List<int>(Array.ConvertAll(a.Split(' '), int.Parse));
