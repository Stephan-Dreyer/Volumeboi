...
//  Serial.println(pot1_debounce);


  int pot1_percentage_1 = calc_percentage(pot1_debounce,& prev_pot1);
  ...
  pot1_percentage = scale(pot1_percentage_1);
...
//      Serial.println(pot1_percentage_1);
